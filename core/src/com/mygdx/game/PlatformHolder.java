    ...
    public void updatePlatformScene(){
        ...
        switch(platformScene){
            ...
            case 2:
                ...
                break;
            case 3:
                addPlatform(-1000,0,400,6000,true,false); //Spawn platform
                addPlatform(3600, 500, 150, 1500, true, false); //Truck bed
                addPlatform(3700, 800, 50, 150, true, false); //left platform above truck
                addPlatform(4100, 750, 50, 150, true, false); //middle platform above truck
                addPlatform(4500,800, 50, 150, true, false); //right platform above truck
